...
def compute_orct1inverse(bayer):
    ...
    for row_index in range(0, bayer_number_of_rows, 2):
        for column_index in range(0, bayer_number_of_columns, 2):
            ...
            final_block[row_index][column_index] = converted_gr_r[1]
            final_block[row_index + 1][column_index + 1] = converted_gr_r[0]

            final_block[row_index + 1][column_index] = converted_gb_b[1]
            final_block[row_index][column_index + 1] = converted_gb_b[0]
